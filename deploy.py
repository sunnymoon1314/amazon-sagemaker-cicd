...
# 05.05.2024 Soon: To change to a small instance type. KIV.
endpoint_instance_type = 'ml.m2.micro' # ml.m5.large

# 05.05.2024 Soon: To change to the S3 bucket name. KIV.
BUCKET_NAME = 'sample-sagemaker-cicd-tuto1'
# 05.05.2024 Soon: To change to the S3 bucket folder. KIV.
PREFIX = 'bouston-housing-regression'
# 05.05.2024 Soon: To change to the training data file. KIV.
...
attached_predictor = attached_estimator.deploy(initial_instance_count=initial_instance_count,
                                               ...
                                               tags=[{"Key": "email", "Value": "ali@datachef.co"}],
                                               wait=False)
